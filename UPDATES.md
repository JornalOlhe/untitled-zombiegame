...
No Windows, a v10 compara a versão do executável com as tags `vN` publicadas. Quando uma tag mais nova como `v14` estiver disponível, o jogo informa que a versão instalada está desatualizada e oferece o download do asset `DeadRecoil-Windows.exe`.
...
Cada push na `main` executa testes de interface e gera builds de validação. A v14 possui um workflow dedicado que testa a UI, compila Android/Windows e publica a prerelease somente quando todos os jobs passam.
